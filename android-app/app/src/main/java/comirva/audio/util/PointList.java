...
public class PointList
{
   ...
   *                  the minimum of the first coordinate observed, etc.
   */
   ...
   *                  the maximum of the first coordinate observed, etc.
   */
   ...
   *
   * @param i int must be a valid index
  ...
  {
    //get mean, variance and standard deviation for normalization
    Matrix mean = getMean();
